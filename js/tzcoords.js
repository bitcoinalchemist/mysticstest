// tzcoords.js — IANA zone reference-city coordinates [lat, lon]
// Generated from the tz database's zone.tab (public domain).
// Used by solartime.html to derive longitude from the birthplace picker;
// lat is included for future use (astrology Tier 2: Ascendant/houses).
window.TZ_COORDS = {
